...
#ifndef CHROME_BROWSER_UI_VIEWS_IPFS_IPFS_INFO_BUBBLE_VIEW_H_
#define CHROME_BROWSER_UI_VIEWS_IPFS_IPFS_INFO_BUBBLE_VIEW_H_
...
class IpfsInfoBubbleView : public PageInfoBubbleViewBase,
 ...
 public:
  ...
  static views::BubbleDialogDelegateView* CreateIpfsInfoBubble(
 ...
 private:
  ...
  IpfsBubbleHeaderView* header_ = nullptr;
  ...
  base::WeakPtrFactory<IpfsInfoBubbleView> weak_factory_{this};

  DISALLOW_COPY_AND_ASSIGN(IpfsInfoBubbleView);
};

#endif  // CHROME_BROWSER_UI_VIEWS_IPFS_IPFS_INFO_BUBBLE_VIEW_H_
